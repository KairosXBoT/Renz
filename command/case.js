...
//start script
			async function starts() {
				...
				haruka.version = [2, 22,2, 73]  //jika ada update dari WhatsApp web silahkan ubah
...
//greetings
    ...
    try {
      ...
      if (anu.action == "add" && mem.includes(haruka.user.jid)) {
        haruka.sendMessage(anu.jid, "Minasankon'nichiwa ", "conversation");
      }
